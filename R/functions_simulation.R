...
fetch_bastidas_ponce_pancreas_data <- function(conda_env_name = "scLANE_venv", conda_bin_path = "/apps/conda/22.11.1/condabin/conda") {
  # check inputs 
...
simulate_single_subject <- function(ref.dataset = NULL,
  ...
  pec.dyn.genes <- perc.dyn.genes * 0.01
