...
```{r}
tar_load(scLANE_GLM_panc_DEG_1_N_100)
tar_load(scLANE_GLM_panc_DEG_1_N_250)
tar_load(scLANE_GLM_panc_DEG_1_N_500)
tar_load(scLANE_GLM_panc_DEG_1_N_1000)
tar_load(scLANE_GLM_panc_DEG_1_N_3000)
tar_load(scLANE_GLM_panc_DEG_1_N_5000)
tar_load(scLANE_GLM_panc_DEG_5_N_100)
tar_load(scLANE_GLM_panc_DEG_5_N_250)
tar_load(scLANE_GLM_panc_DEG_5_N_500)
tar_load(scLANE_GLM_panc_DEG_5_N_1000)
tar_load(scLANE_GLM_panc_DEG_5_N_3000)
tar_load(scLANE_GLM_panc_DEG_5_N_5000)
tar_load(scLANE_GLM_panc_DEG_10_N_100)
tar_load(scLANE_GLM_panc_DEG_10_N_250)
tar_load(scLANE_GLM_panc_DEG_10_N_500)
tar_load(scLANE_GLM_panc_DEG_10_N_1000)
tar_load(scLANE_GLM_panc_DEG_10_N_3000)
tar_load(scLANE_GLM_panc_DEG_10_N_5000)
tar_load(scLANE_GLM_panc_DEG_20_N_100)
tar_load(scLANE_GLM_panc_DEG_20_N_250)
tar_load(scLANE_GLM_panc_DEG_20_N_500)
tar_load(scLANE_GLM_panc_DEG_20_N_1000)
tar_load(scLANE_GLM_panc_DEG_20_N_3000)
tar_load(scLANE_GLM_panc_DEG_20_N_5000)
```
