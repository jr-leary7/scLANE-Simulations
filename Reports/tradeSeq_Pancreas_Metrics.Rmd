---
title: "Process `tradeSeq` Model Results on Pancreas Data"
...
```{r}
tar_load(tradeSeq_panc_DEG_1_N_100, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_1_N_250, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_1_N_500, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_1_N_1000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_1_N_3000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_1_N_5000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_5_N_100, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_5_N_250, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_5_N_500, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_5_N_1000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_5_N_3000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_5_N_5000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_10_N_100, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_10_N_250, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_10_N_500, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_10_N_1000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_10_N_3000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_10_N_5000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_20_N_100, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_20_N_250, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_20_N_500, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_20_N_1000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_20_N_3000, store = "store_tradeSeq")
tar_load(tradeSeq_panc_DEG_20_N_5000, store = "store_tradeSeq")
```

# Metric Computation

```{r}
tradeSeq_panc_metrics <- purrr::map(ls(pattern = "tradeSeq_*"), function(u) {
...
tradeSeq_panc_metrics <- purrr::reduce(tradeSeq_panc_metrics, rbind) %>% 
...
```{r}
qs::qsave(tradeSeq_panc_metrics, file = "/blue/rbacher/j.leary/repos/scLANE-Simulations/Data/Metrics_tradeSeq_Single_Subject_Pancreas")
```
