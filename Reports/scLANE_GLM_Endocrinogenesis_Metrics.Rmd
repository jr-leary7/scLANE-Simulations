---
title: "Process `scLANE (GLM)` Model Results on Endocrinogenesis Data"
...
```{r}
tar_load(scLANE_GLM_endo_DEG_1_N_100, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_1_N_250, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_1_N_500, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_1_N_1000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_1_N_3000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_1_N_5000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_5_N_100, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_5_N_250, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_5_N_500, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_5_N_1000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_5_N_3000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_5_N_5000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_10_N_100, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_10_N_250, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_10_N_500, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_10_N_1000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_10_N_3000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_10_N_5000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_20_N_100, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_20_N_250, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_20_N_500, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_20_N_1000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_20_N_3000, store = "store_scLANE_GLM")
tar_load(scLANE_GLM_endo_DEG_20_N_5000, store = "store_scLANE_GLM")
```

# Metric Computation

```{r}
scLANE_endo_metrics <- purrr::map(ls(pattern = "scLANE_GLM_*"), function(u) {
...
scLANE_endo_metrics <- purrr::reduce(scLANE_endo_metrics, rbind) %>% 
...
```{r}
qs::qsave(scLANE_endo_metrics, file = "/blue/rbacher/j.leary/repos/scLANE-Simulations/Data/Metrics_scLANE_GLM_Single_Subject_Endocrinogenesis")
```
