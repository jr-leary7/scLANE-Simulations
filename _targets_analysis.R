...
list(
  tar_target(file_Metrics_scLANE_GLM_Single_Subject_Endocrinogenesis, 
             ...
             format = "file", 
             deployment = "main"), 
  tar_target(file_Metrics_scLANE_GEE_Multi_Subject_Endocrinogenesis, 
             "Data/Metrics_scLANE_GEE_Multi_Subject_Endocrinogenesis", 
             format = "file", 
             deployment = "main"), 
  tar_target(file_Metrics_Lamian_GEE_Multi_Subject_Endocrinogenesis, 
             "Data/Metrics_Lamian_GEE_Multi_Subject_Endocrinogenesis", 
             format = "file", 
             deployment = "main"), 
  ...
  tar_target(file_Metrics_scLANE_GLM_Single_Subject_Pancreas, 
             ...
             format = "file", 
             deployment = "main"), 
  tar_target(file_Metrics_scLANE_GEE_Multi_Subject_Pancreas, 
             "Data/Metrics_scLANE_GEE_Multi_Subject_Pancreas", 
             format = "file", 
             deployment = "main"), 
  tar_target(file_Metrics_Lamian_GEE_Multi_Subject_Pancreas, 
             "Data/Metrics_Lamian_GEE_Multi_Subject_Pancreas", 
             format = "file", 
             deployment = "main"), 
  ...
  tar_target(file_Metrics_scLANE_GLM_Single_Subject_Brain, 
             ...
             format = "file", 
             deployment = "main"), 
  tar_target(file_Metrics_scLANE_GEE_Multi_Subject_Brain, 
             "Data/Metrics_scLANE_GEE_Multi_Subject_Brain", 
             format = "file", 
             deployment = "main"), 
  tar_target(file_Metrics_Lamian_GEE_Multi_Subject_Brain, 
             "Data/Metrics_Lamian_GEE_Multi_Subject_Brain", 
             format = "file", 
             deployment = "main"), 
  ...
  tar_target(Metrics_scLANE_GEE_Multi_Subject_Endocrinogenesis, 
             qs::qread(file_Metrics_scLANE_GEE_Multi_Subject_Endocrinogenesis)), 
  tar_target(Metrics_Lamian_GEE_Multi_Subject_Endocrinogenesis, 
             qs::qread(file_Metrics_Lamian_GEE_Multi_Subject_Endocrinogenesis)), 
  ...
  tar_target(Metrics_scLANE_GEE_Multi_Subject_Pancreas, 
             qs::qread(file_Metrics_scLANE_GEE_Multi_Subject_Pancreas)), 
  tar_target(Metrics_Lamian_GEE_Multi_Subject_Pancreas, 
             qs::qread(file_Metrics_Lamian_GEE_Multi_Subject_Pancreas)), 
  ...
  tar_target(Metrics_scLANE_GEE_Multi_Subject_Brain, 
             qs::qread(file_Metrics_scLANE_GEE_Multi_Subject_Brain)), 
  tar_target(Metrics_Lamian_GEE_Multi_Subject_Brain, 
             qs::qread(file_Metrics_Lamian_GEE_Multi_Subject_Brain)), 
  ...
  tar_target(metric_table_master, purrr::reduce(list(Metrics_scLANE_GLM_Single_Subject_Endocrinogenesis,
                                                     Metrics_scLANE_GEE_Multi_Subject_Endocrinogenesis,
                                                     Metrics_Lamian_GEE_Multi_Subject_Endocrinogenesis,
                                                     Metrics_tradeSeq_Single_Subject_Endocrinogenesis,
                                                     Metrics_scLANE_GLM_Single_Subject_Pancreas,
                                                     Metrics_scLANE_GEE_Multi_Subject_Pancreas, 
                                                     Metrics_Lamian_GEE_Multi_Subject_Pancreas, 
                                                     Metrics_tradeSeq_Single_Subject_Pancreas, 
                                                     Metrics_scLANE_GLM_Single_Subject_Brain, 
                                                     Metrics_scLANE_GEE_Multi_Subject_Brain, 
                                                     Metrics_Lamian_GEE_Multi_Subject_Brain, 
